                ...
                <div className="banner-container">
                    <div className="section-elements">
                        <div className="container">
                            <h2 className='sub_text_top'>Improve Your Communication <br/> Skill In Just 4 Weeks</h2>
                            <p className='sub_text_middle'>Crack Job Interviews, Deliver Presentations<br/> and Speak to anyone with Confidence.</p>
