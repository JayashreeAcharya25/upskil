            ...
            <div className="navbar-top">
                ...
                <div className="section">
                    ...
                    <ul className='nav-list'>
                        <li className="nav-link"><a href="https://www.upskil.work/s/store">Courses</a></li>
                        <li className="nav-link"><a href="https://www.upskil.work/blog">Blog</a></li>
                        <li className="nav-link"><a href="https://www.upskil.work/aboutus">About</a></li>
                        <li className="nav-link"><a href="https://www.upskil.work/products">Digital Products</a></li>
